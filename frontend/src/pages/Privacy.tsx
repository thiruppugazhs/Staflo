  ...
  return (
    <div className="min-h-screen bg-white text-zinc-900">
      ...
      <div className="mx-auto max-w-[800px] px-4 sm:px-6 py-12">
        <div className="inline-flex items-center gap-2 rounded-full bg-zinc-50 border border-zinc-200 px-3 py-1 text-xs"><ShieldCheck className="h-3.5 w-3.5 text-[#eab308]" /> Privacy Policy</div>
