  ...
  return (
    <div className="min-h-screen bg-white text-zinc-900">
      ...
      <div className="mx-auto max-w-[800px] px-4 sm:px-6 py-12">
        ...
        <p className="text-sm text-zinc-500 mt-1">Last updated: 22 August 2026 • Staflo Technologies Pvt. Ltd.</p>
        <div className="prose prose-zinc max-w-none mt-8 space-y-6 text-sm leading-relaxed">
          <p>At Staflo, your trust is our foundation. We build HR software that handles sensitive people data, so privacy is not a feature — it’s the core of our design.</p>
          ...
          <p>To provide the Staflo service, secure your workspace, and improve reliability. We never sell your data. Aggregated, anonymized analytics may be used to improve performance.</p>
          ...
          <p>You may request export or deletion of your workspace data by contacting support@staflo.io. We respond within 7 days.</p>
          <h2 className="text-lg font-semibold">6. Contact</h2>
          <p>Questions? Write to <span className="font-medium">privacy@staflo.io</span>.</p>
        </div>
      </div>
