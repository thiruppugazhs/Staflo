    ...
    <div className="min-h-screen bg-[#fcfbf9] text-zinc-900 selection:bg-[#eab308]/15">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-[1280px] px-4 sm:px-6 py-16 sm:py-20">
          <div className="max-w-3xl">
            <div className="inline-flex items-center gap-2 rounded-full bg-white border border-zinc-200 px-3 py-1 text-xs text-zinc-600 shadow-sm"><Building2 className="h-3.5 w-3.5 text-[#eab308]" /> About DailyFlow</div>
            <h1 className="mt-4 text-[36px] sm:text-[46px] font-bold tracking-tight leading-[0.95] text-zinc-900">People operations,<br/><span className="text-[#d97706]">perfectly aligned.</span></h1>
      ...
      <section className="mx-auto max-w-[1280px] px-4 sm:px-6 pb-16">
        <div className="rounded-2xl border border-zinc-200 bg-white p-8">
          <div className="flex items-center gap-2 text-xs font-semibold tracking-[0.12em] text-[#eab308]"><Sparkles className="h-3.5 w-3.5" /> OUR STORY</div>
