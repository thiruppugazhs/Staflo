      ...
      <section className="mx-auto max-w-[1280px] px-4 sm:px-6 pb-10">
          ...
          {[
            ...
            <div key={s.step} className="rounded-2xl border border-zinc-200 bg-white p-6 flex flex-col shadow-sm">
              <div className="flex items-center justify-between">
                <div className="h-10 w-10 rounded-xl bg-[#004E72] text-white flex items-center justify-center"><s.icon className="h-5 w-5" /></div>
                <span className="text-xs px-2 py-1 rounded-full bg-zinc-50 border border-zinc-200">{s.time}</span>
              </div>
              <div className="text-xs tracking-widest font-semibold text-[#004E72] mt-4">STEP {s.step}</div>
              ...
              <Link to="/signup" className="mt-4 text-sm font-medium text-[#004E72] flex items-center gap-1">{s.cta} <ArrowRight className="h-4 w-4" /></Link>
            </div>
          ))}
        </div>
        ...
        <div className="mt-6 rounded-2xl border border-zinc-200 bg-white p-6 flex flex-col lg:flex-row items-center gap-6">
          ...
          <div className="w-full lg:w-[360px] aspect-video rounded-xl bg-zinc-100 border border-zinc-200 flex items-center justify-center text-zinc-400">
            <div className="h-12 w-12 rounded-full bg-[#004E72] text-white flex items-center justify-center"><Play className="h-5 w-5 ml-0.5" /></div>
          </div>
        </div>

        <div className="mt-6 rounded-2xl bg-[#004E72] text-white p-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <Link to="/signup"><button className="inline-flex items-center justify-center rounded-full bg-white text-[#004E72] px-6 h-10 font-medium">Create Company — Free <ArrowRight className="ml-2 h-4 w-4" /></button></Link>
        </div>
      </section>
